...
![<span class="fig-credit">Source: https://github.com/oxford-arc/jade-docs/blob/d41e96075db7a8707738349a2db0917094de843c/docs/source/images/AMD-MI300X.png</span>](img/oxford-arc/AMD-MI300X.png)
...
<style type="text/css">
 .reveal img.gh-fig {
    object-fit:cover; width: 400px; height: 360px;
 }
</style>

![](img/n8-cir-bede/logo-cmyk.png){fig-alt="N8 CIR Bede Logo"}

![NVIDIA Grace Hopper Superchip.<br/><span class="fig-credit">Source: https://nvidianews.nvidia.com/news/nvidia-grace-hopper-superchips-designed-for-accelerated-generative-ai-enter-full-productionM</span>](img/nvidia/nvidia-gh200-grace-hopper-superchip-platform.png){.gh-fig}
