...
Per-node (a) throughput and (b) efficiency for Celeritas v0.5.1 on Perlmutter & Frontier. <br /> Generated using `update-plots.py` from commit [d5b5c03](https://github.com/celeritas-project/regression/tree/d5b5c03773dc47756bc09368ed3b0056e689b12e)
