...
Per-node (a) throughput and (b) efficiency for Celeritas `v0.5.1` on Frontier & Perlmutter. <br /> Generated using `update-plots.py` from commit [d5b5c03](https://github.com/celeritas-project/regression/tree/d5b5c03773dc47756bc09368ed3b0056e689b12e)
...
- Bede GH200
  ...
  - G4 GPU offload errors with CUDA OOM
    - 72 CPUs for 1 GPU is not typical
...
![Per-node throughput for AMD systems (Frontier & JADE 2.5)](img/generated/combinations/event-per-node-frontier-jadearc.png){height="540"}
...
![Per-node throughput for NVIDIA HPC systems (Perlmutter & Bede GH200)](img/generated/combinations/event-per-node-perlmutter-bede.png){height="540"}
...
![Per-node throughput for NVIDIA HPC systems (Perlmutter & Bede GH200).<br />To account for the difference in GPU count per node (4 vs 1)](img/generated/combinations/event-per-task-gpu-only-perlmutter-bede.png){height="540"}
